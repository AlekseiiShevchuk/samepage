...
@section('content')
    ...
    {!! Form::model($image, ['method' => 'PUT', 'route' => ['images.update', $image->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($image->image)
                        <a href="{{ asset('uploads/'.$image->image) }}" target="_blank"><img src="{{ asset('uploads/thumb/'.$image->image) }}"></a>
                    @endif
